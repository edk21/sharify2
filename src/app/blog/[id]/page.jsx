...
const BlogDetails = (ctx) => {
    ...
    useEffect(() => {
      async function fetchComments(){
        const res = await fetch(`https://sharify-jw0b7axnn-edk21.vercel.app/comment/${ctx.params.id}`, {cache: 'no-store'})
    ...
    useEffect(() => {
        async function fetchBlog() {
            const res = await fetch(`https://sharify-jw0b7axnn-edk21.vercel.app/api/blog/${ctx.params.id}`, { cache: 'no-store' })
    ...
    const handleComment = async () => {
        ...
        try {
            ...
            const res = await fetch(`https://sharify-jw0b7axnn-edk21.vercel.app/api/comment`, {
                headers: {
